...
"8:9,7:2,8,7:2,8:18,7,8:10,4,8,5,8:2,2,3:9,8:36,6,8:25,1,8:7,0:2")[0];

	private int yy_rmap[] = unpackFromString(1,10,
"0,1:7,2,3")[0];

	private int yy_nxt[][] = unpackFromString(4,9,
"1,2,3,9,4,5,6,8,7,-1:16,8,-1:3,9:2,-1:5");
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -6:
						break;
					case 5:
						{return new Token(TokenType.MIN,yytext(),yychar,yychar+yytext().length());}
					case -7:
						break;
					case 6:
						{return new Token(TokenType.POWER,yytext(),yychar,yychar+yytext().length());}
					case -8:
						break;
					case 7:
